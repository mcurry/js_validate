...
class JsValidateTestCase extends CakeTestCase {
  ...
  function testUrl() {
    ...
    $validation = $this->Validation->bind('JsValidate.JsValidate', array('form' => false));
    $expected = '{"JsValidate.JsValidateUrl":[{"rule":"\/^(?:(?:https?|ftps?|file|news|gopher):\\\\\/\\\\\/)?(?:(?:(?:25[0-5]|2[0-4][0-9]|(?:(?:1[0-9])?|[1-9]?)[0-9])\\\\.){3}(?:25[0-5]|2[0-4][0-9]|(?:(?:1[0-9])?|[1-9]?)[0-9])|\\\\[((([0-9A-Fa-f]{1,4}:){7}(([0-9A-Fa-f]{1,4})|:))|(([0-9A-Fa-f]{1,4}:){6}(:|((25[0-5]|2[0-4]\\\\d|[01]?\\\\d{1,2})(\\\\.(25[0-5]|2[0-4]\\\\d|[01]?\\\\d{1,2})){3})|(:[0-9A-Fa-f]{1,4})))|(([0-9A-Fa-f]{1,4}:){5}((:((25[0-5]|2[0-4]\\\\d|[01]?\\\\d{1,2})(\\\\.(25[0-5]|2[0-4]\\\\d|[01]?\\\\d{1,2})){3})?)|((:[0-9A-Fa-f]{1,4}){1,2})))|(([0-9A-Fa-f]{1,4}:){4}(:[0-9A-Fa-f]{1,4}){0,1}((:((25[0-5]|2[0-4]\\\\d|[01]?\\\\d{1,2})(\\\\.(25[0-5]|2[0-4]\\\\d|[01]?\\\\d{1,2})){3})?)|((:[0-9A-Fa-f]{1,4}){1,2})))|(([0-9A-Fa-f]{1,4}:){3}(:[0-9A-Fa-f]{1,4}){0,2}((:((25[0-5]|2[0-4]\\\\d|[01]?\\\\d{1,2})(\\\\.(25[0-5]|2[0-4]\\\\d|[01]?\\\\d{1,2})){3})?)|((:[0-9A-Fa-f]{1,4}){1,2})))|(([0-9A-Fa-f]{1,4}:){2}(:[0-9A-Fa-f]{1,4}){0,3}((:((25[0-5]|2[0-4]\\\\d|[01]?\\\\d{1,2})(\\\\.(25[0-5]|2[0-4]\\\\d|[01]?\\\\d{1,2})){3})?)|((:[0-9A-Fa-f]{1,4}){1,2})))|(([0-9A-Fa-f]{1,4}:)(:[0-9A-Fa-f]{1,4}){0,4}((:((25[0-5]|2[0-4]\\\\d|[01]?\\\\d{1,2})(\\\\.(25[0-5]|2[0-4]\\\\d|[01]?\\\\d{1,2})){3})?)|((:[0-9A-Fa-f]{1,4}){1,2})))|(:(:[0-9A-Fa-f]{1,4}){0,5}((:((25[0-5]|2[0-4]\\\\d|[01]?\\\\d{1,2})(\\\\.(25[0-5]|2[0-4]\\\\d|[01]?\\\\d{1,2})){3})?)|((:[0-9A-Fa-f]{1,4}){1,2})))|(((25[0-5]|2[0-4]\\\\d|[01]?\\\\d{1,2})(\\\\.(25[0-5]|2[0-4]\\\\d|[01]?\\\\d{1,2})){3})))(%.+)?\\\\]|(?:[a-z0-9][-a-z0-9]*\\\\.)*(?:[a-z0-9][-a-z0-9]{0,62})\\\\.(?:(?:[a-z]{2}\\\\.)?[a-z]{2,4}|museum|travel))(?::[1-9][0-9]{0,4})?(?:\\\\\/?|\\\\\/([\\\\!\"\\\\$&\'\\\\(\\\\)\\\\*\\\\+,\\\\-\\\\.@_\\\\:;\\\\=~\\\\\/0-9a-z]|(%[0-9a-f]{2}))*)?(?:\\\\?([\\\\!\"\\\\$&\'\\\\(\\\\)\\\\*\\\\+,\\\\-\\\\.@_\\\\:;\\\\=~\\\\\/0-9a-z]|(%[0-9a-f]{2}))*)?(?:#([\\\\!\"\\\\$&\'\\\\(\\\\)\\\\*\\\\+,\\\\-\\\\.@_\\\\:;\\\\=~\\\\\/0-9a-z]|(%[0-9a-f]{2}))*)?$\/i","message":"There was a problem with the field Url"}]}';
    $this->assertEqual($expected, $validation);
  }
}