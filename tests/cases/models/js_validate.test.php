...
class JsValidateTestCase extends CakeTestCase {
  ...
  function testCC() {
    ...
    $validation = $this->Validation->bind('JsValidate.JsValidate', array('form' => false));
    $expected = '{"JsValidateCc":[{"rule":"cc","message":"There was a problem with the field Cc"}]}';
    $this->assertEqual($expected, $validation);
  }
  ...
  function testIsUnique() {
    ...
    $validation = $this->Validation->bind('JsValidate.JsValidate', array('form' => false));
    $expected = '{"JsValidateIsUnique":[{"rule":"isUnique","message":"There was a problem with the field IsUnique"}]}';
    $this->assertEqual($expected, $validation);
  }
